...
# Create dataset
X, y = nnfs.datasets.spiral_data(samples=200, classes=3)
# Create model

# first dense layer, 2 inputs
dense1 = Layer_Dense(2, 256, weight_regularizer_l2=5e-3,
                    bias_regularizer_l2=5e-3) 
activation1 = Activation_ReLU()
dense2 = Layer_Dense(256, 3) # second dense layer, 3 inputs, 3 outputs
